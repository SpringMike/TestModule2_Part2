...
public class EmployeeController {
    ...
    public ModelAndView showPhoneList(@RequestParam("s") Optional<String> s, @PageableDefault(size = 6) Pageable pageable) {
    ...
    public ModelAndView deleteCustomer(@ModelAttribute("employee") Employee employee){
        ...
        ModelAndView modelAndView = new ModelAndView("/employee/delete");
        modelAndView.addObject("message", "employee delete successfully");
        return modelAndView;
    }
}
